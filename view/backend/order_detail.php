<div class="col-md-10 col-xs-offset-1">
	...
	<?php 
		...
		{
	 ?>
		<a style="background-color: #8bc34a" href="admin.php?controller=order_detail&act=sent&order_id=<?php echo $order_id; ?>" class="btn btn-primary">Giao hàng</a>&nbsp;
		<?php } ?>
	...
	<div class="panel panel-primary">
		<div style="background-color: #8bc34a" class="panel-heading">Chi tiết hoá đơn</div>
			...
			<table class="table table-bordered table-hover">
				...
				<?php 
					foreach($arr as $rows)
					{
						...
						$product = model::get_a_record("select * from product where pk_product_id=".$rows->fk_product_id);
				 ?>				 
				<tr>
					<td style="text-align: center;"><img src="public/upload/product/<?php echo $product->img_product; ?>" style="width:100px;"></td>
